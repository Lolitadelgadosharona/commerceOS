...
class CreativeQualityReview(IdMixin, TimestampMixin, VersionMixin, Base):
    ...
    brand_consistency_score: Mapped[float | None] = mapped_column(nullable=True)
    claim_safety_score: Mapped[float | None] = mapped_column(nullable=True)
    product_accuracy_score: Mapped[float | None] = mapped_column(nullable=True)
    channel_suitability_score: Mapped[float | None] = mapped_column(nullable=True)
    customer_relevance_score: Mapped[float | None] = mapped_column(nullable=True)
