...
| Decision | Venture, creative, channel, negotiation, and sales/support intelligence recommendations | Versioned recommendations, supplied advisory classifications, risk observations, and decision rationale | Conversation/support execution, financial truth or commitment, Product Truth, AI authority policy, approval authority | Build, Growth, Operations, Governance, Finance |
