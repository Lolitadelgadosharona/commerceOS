...
| Build | Approved products, append-only Product Truth, supporting product knowledge, brand claim guardrails, and creative asset/version/performance-observation records | Governed product facts, Build lifecycle state, artifact registry, sequential asset versions, QA state, and supplied performance observations | Governance approvals, Intelligence hypotheses, supplier/payment truth, paid/channel execution, publishing, ledger truth | Decision, Growth, Operations, Governance, Learning |
