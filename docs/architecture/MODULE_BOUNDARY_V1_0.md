...
|---|---|---|---|
| Intelligence | `CustomerSignal`, `SignalCluster`, `MarketOpportunity`, opportunity evidence/scores/risks, `RootCauseCase`, Customer 360 projections | Evidence synthesis, customer/opportunity intelligence, deterministic scoring, clustering, analysis, lineage/confidence | Cannot import Operations customer/order repositories, Finance ledgers, Decision internals, promote a market observation into a venture decision, or write Product Truth/approvals/execution state |
