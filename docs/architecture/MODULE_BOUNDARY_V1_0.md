...
|---|---|---|---|
| Intelligence | `CustomerSignal`, `SignalCluster`, `RootCauseCase`, Customer 360 projections | Evidence synthesis, customer intelligence, clustering, analysis, lineage/confidence | Cannot import Operations customer/order repositories, Finance ledgers, Decision internals, or write Product Truth/approvals/execution state |
