...
|---|---|---|---|
| Intelligence | `CustomerSignal`, `SignalCluster`, `MarketOpportunity`, opportunity/product hypotheses, evidence/economics/scores/risks, `RootCauseCase`, Customer 360 projections | Evidence synthesis, customer/opportunity/product intelligence, deterministic scoring and economics, clustering, analysis, lineage/confidence | Cannot import Operations customer/order repositories, Finance ledgers, Decision internals, promote a hypothesis into a venture/Build product, select/pay suppliers, or write Product Truth/approvals/execution state |
| Decision | `VentureOpportunity`, `Decision`, creative/channel strategies and recommendations | Evidence-backed alternatives, recommendation/decision records, economics requests, rationale | Cannot import Build/Growth/Operations infrastructure, execute providers/channels, write financial truth, or approve its own decision |
| Build | `Product`, versioned `ProductTruth`, `ProductKnowledgeItem`, `ProductClaimPolicy`, creative artifacts/executions | Product/creative construction, product knowledge and claim guardrails, QA state, model-execution records, approved Product Truth publication workflow | Cannot import Growth channel adapters, Learning internals, Finance ledgers, Intelligence hypotheses, or self-authorize publication/spend |
