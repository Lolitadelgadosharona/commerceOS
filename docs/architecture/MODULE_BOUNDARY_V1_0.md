...
| Build | `Product`, versioned `ProductTruth`, creative artifacts/executions | Product/creative construction, QA state, model-execution records, approved Product Truth publication workflow | Cannot import Growth channel adapters, Learning internals, Finance ledgers, or self-authorize publication/spend |
