...
from apps.api.build_readiness_routes import router as build_readiness_router
...
from apps.api.creative_intelligence_routes import router as creative_intelligence_router
...
from apps.api.demand_intelligence_routes import router as demand_intelligence_router
...
from apps.api.growth_activation_routes import router as growth_activation_router
from apps.api.growth_conversation_learning_routes import (
    router as growth_conversation_learning_router,
)
...
from apps.api.listing_governance_routes import router as listing_governance_router
...
api_router.include_router(build_readiness_router, tags=["build_readiness"])
...
api_router.include_router(growth_discovery_router, tags=["growthos_prospect_discovery"])
api_router.include_router(growth_activation_router, tags=["growthos_revenue_activation"])
