...
createServer((request, response) => {
  ...
  const commerceLists={
    ...
    "/api/v1/product-hypotheses":[productHypothesis],"/api/v1/product-economics":[productEconomics],"/api/v1/supplier-candidates":[productSupplier],"/api/v1/product-risks":[productRisk],"/api/v1/product-investment-scores":[productScore],"/api/v1/products":[],"/api/v1/product-truth":[],
  };
